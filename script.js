  ...
  for (let i = 0; i < 30; i++) {
    ...
    particle.animate(
      [
        ...
        {
          transform: `translateY(-${Math.random() * 100}px) translateX(${Math.random() * 50}px)`,
          opacity: 0.5,
        },
        {
          transform: `translateY(-${Math.random() * 200}px) translateX(0)`,
          opacity: 0,
        },
      ],
      {
...
const initDataStream = () => {
  ...
  for (let i = 0; i < 40; i++) {
    ...
    stream.animate([{ left: "-100px" }, { left: "110%" }], {
